...
namespace Car_rental.Controllers
{
    public class CarController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ReleaseDate,Type,Price")] Car car)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,ReleaseDate,Type,Price")] Car car)
        {
            if (id != car.Id)
            {
                return NotFound();
